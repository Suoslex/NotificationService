...
DATABASE_NAME = os.getenv("DATABASE_NAME", "notification-service")
DATABASE_USER = os.getenv("DATABASE_USER", "user")
DATABASE_PASSWORD = os.getenv("DATABASE_PASSWORD", "user")
...
JWT_KEYCLOAK_SECRET_KEY = os.getenv("JWT_KEYCLOAK_SECRET_KEY", "dev-secret")
JWT_KEYCLOAK_CLIENT_ID = os.getenv(
    "JWT_KEYCLOAK_CLIENT_ID",
    "notification-service"
)
JWT_KEYCLOAK_ADMIN_LOGIN = os.getenv("JWT_KEYCLOAK_ADMIN_LOGIN", "admin")
JWT_KEYCLOAK_ADMIN_PASSWORD = os.getenv("JWT_KEYCLOAK_ADMIN_PASSWORD", "admin")
JWT_KEYCLOAK_URL = f"http://{JWT_KEYCLOAK_HOST}:{JWT_KEYCLOAK_PORT}"
...
EMAIL_NOTIFICATIONS_ENABLED = (
    os.getenv("EMAIL_NOTIFICATIONS_ENABLED", "True") != "False"
)
EMAIL_NOTIFICATIONS_SMTP_SERVER = (
    os.getenv("EMAIL_NOTIFICATIONS_SMTP_SERVER", "localhost")
)
EMAIL_NOTIFICATIONS_SMTP_PORT = (
    int(os.getenv("EMAIL_NOTIFICATIONS_SMTP_PORT", "587"))
)
EMAIL_NOTIFICATIONS_SMTP_USERNAME = (
    os.getenv("EMAIL_NOTIFICATIONS_SMTP_USERNAME", "")
)
EMAIL_NOTIFICATIONS_SMTP_PASSWORD = (
    os.getenv("EMAIL_NOTIFICATIONS_SMTP_PASSWORD", "")
)
EMAIL_NOTIFICATIONS_FROM_ADDRESS = (
    os.getenv(
        "EMAIL_NOTIFICATIONS_FROM_ADDRESS",
        "notification@photopoint.com"
    )
)
